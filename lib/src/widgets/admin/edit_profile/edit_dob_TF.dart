...
// Class
class EditDateTextField extends StatefulWidget {
  // Attributes
  final TextEditingController controller;
  final double width;

  // Constructor
  const EditDateTextField({
    Key? key,
  ...
  @override
  State<EditDateTextField> createState() => EditDateTextFieldState();
}

class EditDateTextFieldState extends State<EditDateTextField> {
